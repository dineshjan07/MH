...
public class UNB_RET_CREDITCARD_PAYMENT_DET_REQOUT extends UserRule{
	private static Logger log = LoggerFactory
	.getLogger(UNB_RET_CREDITCARD_PAYMENT_DET_REQOUT.class);

public int Process(HashMap orderedhashtable, String pIPMsg, String s,
	HashMap orderedhashtable1, ErrorHandler erHandler) {

log.debug("Inside UNB_RET_CREDITCARD_PAYMENT_DET_REQOUT  --->>>" + pIPMsg);
...
if (pIPMsg == null) {
	...
	try {
		...
		inputStr = inputStr.replaceAll("<xml><RET_CREDITCARD_PAYMENT_DET_REQ_COMP_OUT>","");
		inputStr = inputStr.replaceAll("</RET_CREDITCARD_PAYMENT_DET_REQ_COMP_OUT></xml>","");
		
		
		
		
	String[] inputDetails={"<T24WSInquiryData_Out>","</T24WSInquiryData_Out>","<T24WSRequestParams_Out>","</T24WSRequestParams_Out>","req_narrationCount_out","<gNarration_Out","<gNarration_Out>","</gNarration_Out>","<RET_CREDITCARD_PAYMENT_DET_REQ_BODY_OUT>","</RET_CREDITCARD_PAYMENT_DET_REQ_BODY_OUT>"};
		String[] outputDetails={"<T24WSInquiryData>","</T24WSInquiryData>","<T24WSRequestparams>","</T24WSRequestparams>","g","<gNarration","<gNarration>","</gNarration>","","","",""};
		
		//"<gNarration_Out>","</gNarration_Out>"
	//String[] inputDetails={"<T24WSRequestParams_Out>","</T24WSRequestParams_Out>","<RET_CREDITCARD_PAYMENT_DET_REQ_BODY_OUT>","</RET_CREDITCARD_PAYMENT_DET_REQ_BODY_OUT>"};
	//String[] outputDetails={"<T24WSRequestparams>","</T24WSRequestparams>","",""};
	...
	//	StringBuffer headerendtag = new StringBuffer("</soap:Envelope>");
		...
		log.debug("Response Message from the UNB_RET_CREDITCARD_PAYMENT_DET_REQOUT  is ==>"
				+ _cresultMessage[0]);
		return _iresultCode;
	} catch (Exception e) {
		_iresultCode = 2;
		_cresultMessage[0] = "Exception in In_Data_UserExit UNB_RET_CREDITCARD_PAYMENT_DET_REQOUT"
				+ e;
		log.error("Exception in UNB_RET_CREDITCARD_PAYMENT_DET_REQOUT : ", e);
		return _iresultCode;
	}
}
}
